...
var stage = new createjs.Stage("fractal");
stage.canvas.width = window.innerWidth;
stage.canvas.height = window.innerHeight;

var fibonacci = function fibonacci(initialTheta) {
  var dotRadius = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 40;
  var scale = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 400;
  var iterations = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 500;
  var color = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "#523f5f";
  var dotOpacity = 0.4;
  var canvasCenterX = stage.canvas.width / 2;
  var canvasCenterY = stage.canvas.height / 2;

  for (var i = 0; i < iterations; i++) {
    var theta = initialTheta * i;
    var radius = Math.sqrt(i / iterations);
    var x = scale * radius * Math.cos(theta) + canvasCenterX;
    var y = scale * radius * Math.sin(theta) + canvasCenterY;
    console.log(i, x, y);
